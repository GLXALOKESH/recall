...
export default function ReportPage() {
    ...
    return (
        <div className="relative min-h-screen bg-[#F5F3EE] text-[#1A1A2E] selection:bg-[#00897B]/20">
            <DotPattern
                width={16}
                height={16}
                cx={1}
            ...
            <footer className="py-12 border-t border-[#E2DFD8] text-center">
                <p className="text-[13px] text-[#9898AA]">
                    Powered by <span className="font-bold text-[#1A1A2E]">Recall</span> · Verified Mastery Report
                </p>
            </footer>
        </div>
    )
